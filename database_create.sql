...
CREATE TABLE Person (
    ...
    FOREIGN KEY (Faculty_Name , University_Name)
        REFERENCES Faculty (Faculty_Name , University_Name) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Lecturer (
    ...
    PRIMARY KEY (ID),
    FOREIGN KEY (ID)
        REFERENCES Salaried_Employee (ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Course (
    ...
    FOREIGN KEY (Department_Name)
        REFERENCES Department (Name) ON DELETE CASCADE ON UPDATE CASCADE,
